...
<div class="d-flex flex-column flex-lg-row gap-4">
    ...
    <div class="flex-grow-1">
        <h5 class="fw-bold mb-3">{{ __('edit_link') }}</h5>
            ...
            <div class="card-body p-4">
                <form action="{{ route('links.update', ['link' => $link->id]) }}" method="POST" id="edit-form">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label for="title" class="form-label text-primary small fw-medium">
                                    {{ __('title') }}
                                </label>
                            ...
                            <div class="mb-3">
                                <label for="url" class="form-label text-primary small fw-medium">
                            ...
                            <div class="mb-3">
                                <label for="notes" class="form-label text-primary small fw-medium">
                                    {{ __('notes') }}
                                </label>
                        ...
                        <div class="col-lg-6">
                            @if($tags->count())
                            <div class="mb-3">
                                <label class="form-label text-primary small fw-medium">
                                    {{ __('tags') }}
                                </label>
