                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tr>
                            <th class="border-0 rounded-start">
                                <a href="{{ route('users', ['sort' => 'name', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc']) }}" class="text-decoration-none text-body">
                                    {{ __('name') }}
                            ...
                            <th class="border-0">
                                <a href="{{ route('users', ['sort' => 'email', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc']) }}" class="text-decoration-none text-body">
                                    {{ __('email') }}
                            ...
                            <th class="border-0">
                                <a href="{{ route('users', ['sort' => 'role', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc']) }}" class="text-decoration-none text-body">
                                    {{ __('role') }}
                            ...
                            <th class="border-0">
                                <a href="{{ route('users', ['sort' => 'is_active', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc']) }}" class="text-decoration-none text-body">
                                    {{ __('active') }}
